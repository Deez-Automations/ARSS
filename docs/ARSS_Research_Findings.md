...
**Sources:**
- Chavali L., Gupta T., Saxena P. — "SAC-AP: Soft Actor Critic based Deep Reinforcement Learning for Alert Prioritization" — IEEE CEC 2022. DOI: 10.1109/CEC55065.2022.9870423 *(title corrected 2026-09-21)*
- Chavali L., Krishnan A., Saxena P., Mitra B., Chivukula A.S. — "Off-policy actor-critic deep reinforcement learning methods for alert prioritization in intrusion detection systems" — *Computers & Security*, Vol. 142, 2024. DOI: **10.1016/j.cose.2024.103854** *(⚠️ corrected 2026-09-21 — the previously recorded DOI, 10.1016/j.cose.2024.103893, resolved to a completely unrelated paper by different authors; title also corrected. Most serious citation error found to date on this project.)*
- Chavali L., Saxena P., Mitra B. — "Knowledge Empowered Deep Reinforcement Learning to Prioritize Alerts Generated by Intrusion Detection Systems" — AINA 2024, Springer LNCS. DOI: 10.1007/978-3-031-57916-5_34 *(title corrected 2026-09-21)*
- Chavali L., Saxena P. — "Multi-critic Deep Reinforcement Learning for Enhanced Alert Prioritization in Intrusion Detection Systems" — AINA 2025, Springer LNDECT Vol. 249. DOI: 10.1007/978-3-031-87775-9_15 *(title corrected 2026-09-21)*
...
**Source:**
- Wang X., Yang X., Liang X., Zhang X., Zhang W., Gong X. — "Combating alert fatigue with AlertPro: Context-aware alert prioritization using reinforcement learning for multi-step attack detection" — *Computers & Security*, Vol. 137, 2024. DOI: 10.1016/j.cose.2023.103583 *(title substantially corrected 2026-09-21 — three-way confirmed via Crossref, Semantic Scholar, dblp; full author list also corrected from "et al.")*
