...
\bibitem{chavali2022}
L. Chavali, T. Gupta, and P. Saxena, ``SAC-AP: Soft Actor Critic based Deep Reinforcement Learning for Alert Prioritization,'' in \emph{Proc. IEEE Congress on Evolutionary Computation (CEC)}, 2022. DOI: 10.1109/CEC55065.2022.9870423 \emph{(Title corrected 2026-09-21: verbatim title per Crossref/Semantic Scholar includes the ``SAC-AP:'' prefix, previously dropped here.)}

\bibitem{chavali2024}
L. Chavali, A. Krishnan, P. Saxena, B. Mitra, and A. S. Chivukula, ``Off-policy actor-critic deep reinforcement learning methods for alert prioritization in intrusion detection systems,'' \emph{Computers \& Security}, vol. 142, article 103854, 2024. DOI: 10.1016/j.cose.2024.103854 \emph{(Corrected 2026-09-21: the DOI previously recorded here, 10.1016/j.cose.2024.103893, resolves to an entirely unrelated paper by different authors on a different topic -- confirmed via Crossref. The title was also a paraphrase, missing ``methods'' and ``in intrusion detection systems.'' Both corrected to verbatim Crossref metadata; this is the most serious citation error found in this project's citation-integrity work to date.)}

\bibitem{knap2024}
L. Chavali, P. Saxena, and B. Mitra, ``Knowledge Empowered Deep Reinforcement Learning to Prioritize Alerts Generated by Intrusion Detection Systems,'' in \emph{Proc. Advanced Information Networking and Applications (AINA)}, Springer LNCS, 2024. DOI: 10.1007/978-3-031-57916-5\_34 \emph{(Title corrected 2026-09-21: verbatim Crossref/Semantic Scholar title has no ``KNAP:'' prefix and a different back half than previously recorded here. Note also: this paper's primary abstract remains paywalled -- Springer login wall -- so its headline contribution could only be confirmed via secondary sources as three knowledge-level variants (D-/S-/T-KNAP) reducing defender loss by specific percentages, not the ``sample efficiency'' framing used in Section III of this paper; that framing has not been independently confirmed against primary text and should be rechecked before final submission.)}

\bibitem{chavali2025multicrit}
L. Chavali and P. Saxena, ``Multi-critic Deep Reinforcement Learning for Enhanced Alert Prioritization in Intrusion Detection Systems,'' in \emph{Proc. AINA 2025}, Springer LNDECT vol. 249, 2025. DOI: 10.1007/978-3-031-87775-9\_15 \emph{(Title corrected 2026-09-21: verbatim Crossref/Semantic Scholar title includes ``in Intrusion Detection Systems,'' previously omitted. Abstract remains paywalled -- Springer login wall.)}

\bibitem{alertpro2024}
X. Wang, X. Yang, X. Liang, X. Zhang, W. Zhang, and X. Gong, ``Combating alert fatigue with AlertPro: Context-aware alert prioritization using reinforcement learning for multi-step attack detection,'' \emph{Computers \& Security}, vol. 137, article 103583, 2024. DOI: 10.1016/j.cose.2023.103583 \emph{(Title corrected 2026-09-21: verbatim Crossref/Semantic Scholar/dblp title (three-way agreement) is substantially different from what was previously recorded -- the real title leads with ``Combating alert fatigue'' and specifies ``multi-step attack detection'' as the paper's actual technical scope, both dropped in the prior paraphrase. Full author list also corrected from ``et al.''.)}
